...
> سند تاریخیِ برنامه‌ریزی پیش از ساخت بک‌اند است. مرجع وضعیت فعلی، دستور اجرا و محدودیت‌ها [BACKEND-OPERATIONS.md](BACKEND-OPERATIONS.md) و [IMPLEMENTATION-STATUS.md](IMPLEMENTATION-STATUS.md) است؛ پیشنهادهای این سند لزوماً همگی اجرا نشده‌اند.
