...
Read and follow `AGENT.md`, the repository's canonical project guide. It defines
the architecture boundaries, documentation maintenance rules, verification
commands, and safety requirements for every change.
